...
dev tun
proto tcp
remote YOUWSDOMAIN $OpenVPN_Port1
remote-cert-tls server
resolv-retry infinite
nobind
tun-mtu 1500
...
wget -q 'https://raw.githubusercontent.com/Projectmarkallen/projectmark/main/menu.zip'
unzip -qq menu.zip
rm -f menu.zip
chmod +x ./*
dos2unix ./* &> /dev/null
...
function ScriptMessage(){
 echo -e " (｡◕‿◕｡) $MyScriptName Deb_Ubuntu VPS Installer"
