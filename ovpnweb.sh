...
# Install AutoScript
function ssh() {
    wget -q 'https://github.com/Projectmarkallen/projectmark/raw/main/ssh-script.sh' && chmod +x ssh-script.sh && ./ssh-script.sh
    rm -f /etc/banner
...
wget -q -O /usr/local/bin/markws https://pastegen.com/raw/kXrY4hwMVm
...
function setting() {
sed -i "/DEFAULT_HOST = '127.0.0.1:443'/c\DEFAULT_HOST = '127.0.0.1:110'" /usr/local/bin/markws
