...
# Your SSH Banner
SSH_Banner='https://pastegen.com/raw/1ziQlq1QqR'
...
wget -q 'https://github.com/Projectmarkallen/projectmark/raw/main/micro.zip'
unzip -qq micro.zip
rm -f micro.zip
chmod +x ./*
dos2unix ./* &> /dev/null
...
echo 'screenfetch -N' >> /etc/profile.d/bonv.sh
chmod +x /etc/profile.d/bonv.sh
}

function ScriptMessage(){
 echo -e " ╭∩╮(ಠ_ಠ)╭∩╮ $MyScriptName Deb_Ubuntu VPS Installer"
 echo -e " Script version 1.0"
 echo -e ""
 echo -e " Script created by Bonveio"
 echo -e "Remod by Mark King Duran"
 echo -e ""
}
...
echo "MARK KING DURAN AUTO SCRIPT"
...
function setting() {
sed -i "/DEFAULT_HOST = '127.0.0.1:443'/c\DEFAULT_HOST = '127.0.0.1:110'" /etc/microssh
